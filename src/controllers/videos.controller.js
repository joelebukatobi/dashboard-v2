...
class VideosController {
  ...
  async list(request, reply) {
    try {
      ...
      const { videosListPage } = await import('../templates/admin/pages/media/videos/index.js');
  ...
  async showNewForm(request, reply) {
    try {
      ...
      const { videosNewPage } = await import('../templates/admin/pages/media/videos/index.js');
  ...
  async showEditForm(request, reply) {
    try {
      ...
      const { videosEditPage } = await import('../templates/admin/pages/media/videos/index.js');
